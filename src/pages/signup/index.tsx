...
import { supabase } from "../api/auth/[...nextauth]";
					...
					<div className="layout-container flex h-full grow flex-col">
						...
						<form className="w-full flex flex-1 justify-center py-5" onSubmit={onSubmit} method="POST">
							<div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5  flex-1">
								<h1 className="text-[#111418] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 text-center pb-3 pt-5">Sign Up</h1>
								...
								<div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
									<label className="flex flex-col min-w-40 flex-1">
										<span className="text-[#111418] text-base font-medium leading-normal pb-2">Confirm Password</span>
										<input
								...
								<span className="text-[#60758a] text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center" >Already have an account?</span>
								<div className="flex px-4 py-3">
									<button
